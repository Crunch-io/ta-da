...
Try out your new search experience by clicking the AI beta toggle in the search bar.
...
If there are multiple results, simply click to expand and see more.

{{<figure src="https://player-crunch-io.s3.amazonaws.com/help-crunch-io/screenshots/ai-search-nov-2025-06.png" width=600 class="img-fluid">}}

You can click on the search result to open the result in the same window, or click on the icon to open the search results in a new tab.

## Try it out today

This feature is currently in [early access](https://help.crunch.io/hc/en-us/articles/360040465331-How-to-enable-early-access). For full details of this new feature, see the [help center](https://help.crunch.io/hc/en-us/articles/40867072211469-AI-Powered-Search-in-Crunch).
